...
// interfaces
import type { UserAddProps } from '@/interfaces/api/User'
...
const UserAddView = ({ control, alert, isSubmitting = false, isDisabled = false, onSubmit, onCancel }: UserAddProps): JSX.Element => {
  return (
        ...
        <Box margin={{ base: 6, lg: 10 }}>
          <form onSubmit={onSubmit}>
            ...
            <SimpleGrid columns={{ sm: 1, lg: 2 }} spacing='10'>
              ...
              <PasswordInput control={control} name='password' label='Contraseña' placeholder='Ingresa tu contraseña' disabled={isSubmitting} />
            </SimpleGrid>
