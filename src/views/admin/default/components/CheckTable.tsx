...
import { type ColumnInstance, type Row, useGlobalFilter, usePagination, useSortBy, useTable, type UseTableColumnProps } from 'react-table'

// Custom components
import Card from '@/components/card/Card'
import Menu from '@/components/menu/MainMenu'
import {} from '@/components/charts/LineAreaChart'
import { type TableProps } from '../variables/columnsData'
        ...
        <Thead>
          {headerGroups.map((headerGroup, index: number) => (
            <Tr {...headerGroup.getHeaderGroupProps()} key={index}>
              {headerGroup.headers.map((column: ColumnInstance & UseTableColumnProps<object>, index: number) => (
