// Chakra Imports
import { Avatar, Button, Flex, Icon, Menu, MenuButton, MenuItem, MenuList, Text, useColorModeValue, useColorMode } from '@chakra-ui/react'
// Custom Components
...
export default function HeaderLinks (props: HeaderLinksProps): JSX.Element {
