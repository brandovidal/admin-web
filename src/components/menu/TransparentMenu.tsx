...
export default function Banner (props: { icon: JSX.Element | string, [x: string]: any }): JSX.Element {
  ...
  return (
    <Menu isOpen={isOpen1} onClose={onClose1}>
      ...
      <MenuList w='150px' minW='unset' maxW='150px !important' border='transparent' backdropFilter='blur(63px)' bg={bgList} boxShadow={bgShadow} borderRadius='20px' p='15px'>
        <MenuItem
